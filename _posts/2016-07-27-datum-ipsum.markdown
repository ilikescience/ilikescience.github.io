...
<span class="c--gray">*tl;dr — I’ve created a tool called [Datum Ipsum](http://datumipsum.com/) to enable designers to use realistic data when mocking up data visualizations. Also, this is a written version of a talk I gave at Data Viz Camp 2016 in NYC. The slides for that talk are [here](https://slides.com/matthewstrom/datumipsum).*</span>
...
{% include image.html src="/images/datum-1.png" caption="Sprurious correlations are all too easy to find." %}
...
{% include image.html src="/images/datum-2.png" caption="This type of result would have never shown up in a mockup." %}
...
{% include image.html src="/images/datum-3.png" caption="A graph of javascript’s Math.random() function" %}
...
{% include image.html src="/images/datum-4.png" caption="A 2-dimensional graph of the Perlin Noise function" %}
...
{% include image.html src="/images/datum-5.jpeg" caption="Perlin noise" %}
...
{% include image.html src="/images/datum-6.png" caption="A line-graph of perlin noise" %}
...
{% include image.html src="/images/datum-7.png" caption="Summing different walks across the perlin noise function" %}

{% include image.html src="/images/datum-8.png" caption="The result of many walks looks much more interesting than a single walk" %}
...
{% include image.html src="/images/datum-9.png" caption="Combining simple functions with perlin noise" %}
...
{% include image.html src="/images/datum-10.png" caption="Note: for the sake of example, I’ve pulled headlines from The Daily Beast. All of the data is 100% fake." %}
